...
{
  dist_US1 = (Ultrasonic_1.ping_median(5))/US_ROUNDTRIP_CM;
  dist_US2 = (Ultrasonic_2.ping_median(5))/US_ROUNDTRIP_CM;
  dist_US3 = (Ultrasonic_3.ping_median(5))/US_ROUNDTRIP_CM;
